package com.elysian.advanced.spring.exercise.controllers.security;
...
import com.elysian.advanced.spring.exercise.services.security.UserService;
...
@RestController
@RequestMapping("/api.currentsapi.services/v1")
@Slf4j
    ...
    public void refreshToken(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        if (authorizationHeader != null && authorizationHeader.startsWith("Bearer ")) {
            try {
                ...
                Algorithm algorithm = Algorithm.HMAC256("mysecrettokentogeneratekey".getBytes(StandardCharsets.UTF_8));
